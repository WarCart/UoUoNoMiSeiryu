...
public class SeiryuFlyMorphRenderer<T extends AbstractClientPlayerEntity, M extends MorphModel> extends ZoanMorphRenderer<T, M> {
    public SeiryuFlyMorphRenderer(EntityRendererManager renderManager) {
        super(renderManager, UoMorphs.SEIRYU_FLY.get());
        this.removeLayer(HeldItemLayer.class);
        this.addLayer(new PartialZoanHeldItemLayer(this, new SeiryuHeavyModel()));
        this.addLayer(new BoroBreathLayer<>(this, true));
    }
    ...
    public static class Factory<T extends PlayerEntity> implements IRenderFactory<T> {
        ...
        public EntityRenderer<? super T> createRenderFor(EntityRendererManager manager) {
            return new SeiryuFlyMorphRenderer(manager);
        }
    }
}
